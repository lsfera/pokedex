...
lazy_static! {
    ...
    .unwrap();
    pub static ref POKEMON_REQUESTS_TOTAL: Counter =
        Counter::new("pokemon_requests_total", "Total requests to get Pokemon").unwrap();
    ...
    .unwrap();
    pub static ref TRANSLATIONS_TOTAL: Counter =
        Counter::new("translations_total", "Total translation requests").unwrap();
    pub static ref TRANSLATIONS_SUCCEEDED: Counter =
        Counter::new("translations_succeeded", "Successful translations").unwrap();
    pub static ref TRANSLATIONS_FAILED: Counter =
        Counter::new("translations_failed", "Failed translation requests").unwrap();
